...
! function (e) {
    ...
    function m(t) {
        return t.id ? e('<span ><img class="woox-icon" sytle="display: inline-block;" src="img/' + t.element.value.toLowerCase() + '.png" /> ' + t.text + "</span>") : t.text
    }
    CRUMINA.preloader = function () {
        ...
        e(".sorting-container").each((function () {
            ...
            t.isotope({
                ...
                t.isotope("layout")
            })), t.siblings(".sorting-menu").find("li").on("click", (function () {
        ...
        a.length && a.each((function () {
            jQuery(this).waypoint((function () {
                ...
                t.circleProgress({
                    ...
                    t.find(".content").html(parseInt(a * n, 10) + "<span>%</span>")
        ...
        getParams: function (e, t) {
            ...
            return n.slidesPerView > 1 && (n.breakpoints = {
                320: {
                    slidesPerView: 1,
                    slidesPerGroup: 1
                },
        ...
        addEventListeners: function (t) {
            ...
            t.params.prevNext && i.on("click", ".swiper-btn-next, .swiper-btn-prev", (function (n) {
                n.preventDefault(), e(this).hasClass("swiper-btn-next") ? t.slideNext() : t.slidePrev()
        ...
        return e(this).closest(".has-popup").find(".window-popup").toggleClass("active"), i.toggleClass("popup-active"), !1
    ...
    e(".custom-dropdown").on("click", "li:not(.init)", (function () {
        p.removeClass("selected"), e(this).addClass("selected"), e(".custom-dropdown").children(".init").html(e(this).html()), p.toggle()
    })), CRUMINA.overlayMenu = function () {
        e(".js-open-aside").click((function () {
            e("body").toggleClass("popup-active"), e("#overlay-menu").toggleClass("open")
        }))
        ...
        e.material.init(), e(".checkbox > label").on("click", (function () {
        ...
        addEventListeners: function () {
            ...
            this.removeEventListeners(), CRUMINA.isTouch() ? (e(document).on("click.menu", (function (n) {
                ...
                var n = e(this);
                "mouseenter" === t.type && n.find(".sub-menu").addClass("open"), "mouseleave" === t.type && n.find(".sub-menu").removeClass("open")
            }))
        },
        ...
        CRUMINA.elementChart = function () {
            setTimeout((function () {
                e(".js-chart-statistic").each((function () {
                    ...
                    e(this).attr("id", n), Highcharts.stockChart(n, {
                        credits: {
                            enabled: !1
                        },
                        chart: {
        ...
        if ("querySelector" in document && "addEventListener" in window) {
            for (var t = e("#primary-menu a[href*=\\#], .btn[href*=\\#]").filter((function () {
                    return e(this).is(":not([href=\\#])")
                })), n = 0, i = t.length; n < i; n++) {
                new RegExp(window.location.hostname + window.location.pathname).test(t[n].href) && t[n].setAttribute("data-scroll", !0)
            }
            ...
            }), e("#primary-menu").find("[href=\\#]").on("click", (function () {
                return !1
            }))
        }
        ...
        e(".btn--share-js").on("click", (function () {
            ...
            e(this).closest(".btn--share-js").hasClass("open") ? window.Sharer.init() : t.preventDefault()
        }))
        ...
        var i = document.getElementById("pathD"),
            ...
            u = !0;
        c.style.visibility = "visible", d.onclick = function () {
            c.className = "menu-icon-wrapper scaled", u ? (e(s), t(r), e(l)) : (n(s), r.draw(80, 320, .7, {
                delay: .1,
                easing: ease.ease("elastic-out", 2, .4)
            }), n(l)), u = !u, setTimeout((function () {
                ! function (e) {
        ...
        27 == t.which && (e("#overlay-menu").removeClass("open"), i.removeClass("popup-active"), e(".window-popup").removeClass("active"), e("body").removeClass("body-overlay-active"))
    })), CRUMINA.maps = {
        maps: {
            mapMain: {
                config: {
        ...
        e("#menu-icon-wrapper").length && CRUMINA.burgerAnimation(), d.crumegamenu({
            showSpeed: 0,
            hideSpeed: 0,
            trigger: "hover",
            animation: "drop-up",
